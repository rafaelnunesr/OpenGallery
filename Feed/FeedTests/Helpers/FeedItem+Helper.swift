...
extension FeedItem {
    ...
    static func makeItem1() -> (item: FeedItem, json: [String: Any?]) {
        makeItem(
            id: 1,
            title: "Some title",
    ...
    static func makeItem2() -> (item: FeedItem, json: [String: Any?]) {
        makeItem(
            id: 1,
            title: "Some title",
    ...
    static func makeItemsJSON() -> (items: [FeedItem], json: [String: Any?]) {
